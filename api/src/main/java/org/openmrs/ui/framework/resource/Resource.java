...
/**
 * A resource that a page or fragment wants to include. Each resource has an optional priority. (A
 * higher number means it should be included first, and the default is 0.)
 * 
 * @see ResourceFactory
 */
