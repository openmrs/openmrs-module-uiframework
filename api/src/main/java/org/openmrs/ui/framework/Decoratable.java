...
public interface Decoratable {
	...
	/**
	 * Requests that this element be decorated with a fragment. (The output of this element will be
	 * passed to the decorator fragment as the 'content' property of its configuration.)
	 * 
