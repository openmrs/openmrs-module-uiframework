...
/**
 * An {@link UserDefinedPageView} object encapsulates data for a custom user template that is stored
 * in the database, the template scripts are executed on the fly when the page is requested. Only
