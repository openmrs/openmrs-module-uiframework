...
public class FormatterImpl implements Formatter {
	...
	private String format(PersonName n, Locale locale) {
        ...
        try {
            ...
            //String formattedName = FormatterImplHelper.getFormattedName(n);
            Class<?> cls = Class.forName("org.openmrs.ui.framework.FormatterImplHelper");
            Method getFormattedName = cls.getDeclaredMethod("getFormattedName", PersonName.class);
            String formattedName = (String) getFormattedName.invoke(null, n);
