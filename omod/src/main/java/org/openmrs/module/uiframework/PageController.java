...
/**
 * Lets clients access pages via: (in 1.8.4+) .../openmrs/provider/subfolder/pageName.page (in
 * 1.8-1.8.3) .../openmrs/pages/provider/subfolder/pageName.form
 */
@Controller
public class PageController {
	...
	/**
	 * Since the 1.x web application only lets spring handle certain file extensions (not including
	 * .page) we need to let people access pages like: ".../openmrs/pages/home.form"
	 */
	@RequestMapping("/pages/**")
	public String handleUrlStartingWithPage(HttpServletRequest request, HttpServletResponse response, Model model,
